...
# %% auto 0
__all__ = ['logger', 'FASTKAFKA_BASICS_PROMPT', 'write_file_contents', 'read_file_contents', 'validate_python_code',
...
# %% ../../nbs/Helper.ipynb 20
def _get_relevant_document(db_path: str, query: str) -> str:
