...
# %% auto 0
__all__ = ['logger', 'asyncapi_to_latest_version', 'optimize_asyncapi_file', 'generate_asyncapi_spec']
...
def asyncapi_to_latest_version(asyncapi_yaml_path: str) -> None:
    """
...
def optimize_asyncapi_file(asyncapi_yaml_path: str) -> None:
    """
...
def generate_asyncapi_spec(description: str, output_path: str) -> str:
    ...
    with yaspin(
        ...
        asyncapi_to_latest_version(output_file)
        optimize_asyncapi_file(output_file)
