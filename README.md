...
code from user descriptions, speeding up `FastStream` app development.
...
faststream_gen installed on your system. Run the below command from the
terminal to see the full list of available commands:
